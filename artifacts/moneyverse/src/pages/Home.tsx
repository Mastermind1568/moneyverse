...
function CtaStrip({ dark = true }: { dark?: boolean }) {
  return (
    <div style={{
      background: dark ? "var(--mv-black)" : "#fff",
      borderTop: `1px solid ${dark ? "#222" : "var(--mv-n200)"}`,
      borderBottom: `1px solid ${dark ? "#222" : "var(--mv-n200)"}`,
      padding: "40px 64px",
      display: "flex",
      alignItems: "center",
      gap: 32,
      flexWrap: "wrap" as const,
    }} className="cta-strip-pad">
      <Link href="/pricing">
      ...
      <Link href="/free-guide">
        <span style={{ fontFamily: "'Space Mono', monospace", fontSize: 10, letterSpacing: "0.1em", color: dark ? "var(--mv-n400)" : "var(--mv-n600)", cursor: "pointer" }}>
          Download free 17-page guide →
        </span>
      </Link>
      <p style={{ fontFamily: "'Space Mono', monospace", fontSize: 9, color: dark ? "var(--mv-n700)" : "var(--mv-n400)", letterSpacing: "0.1em", margin: 0 }}>
        ONE-TIME · LIFETIME ACCESS · 21-DAY GUARANTEE
      </p>
    </div>
  );
}
  ...
  return (
    <Layout>
        ...
        <div style={{ position: "relative" as const, zIndex: 1 }} className="hero-pad">
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 80, alignItems: "end" }} className="hero-sub-grid">
            <p style={{ fontFamily: "'Playfair Display', serif", fontStyle: "italic", fontSize: "clamp(16px, 1.8vw, 22px)", color: "var(--mv-n400)", lineHeight: 1.75, margin: 0 }}>
              You've worked hard and saved responsibly your whole life. The naira, cedi, and shilling have quietly extracted a little more every year. That's not your failure. The money is broken. This is the 11-module protocol for building your way out.
            </p>
      ...
      <section style={{ borderBottom: "2px solid var(--mv-black)" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", borderBottom: "1px solid #e5e5e5" }} className="two-col-grid">
          <div style={{ background: "var(--mv-black)", color: "#fff", padding: "100px 64px", borderRight: "2px solid #222" }}>
            <span className="accent-rule" style={{ marginBottom: 32 }} />
            <h2 style={{ fontFamily: "'Playfair Display', serif", fontWeight: 900, fontSize: "clamp(1.8rem, 3vw, 2.8rem)", color: "#fff", lineHeight: 1.15, marginBottom: 28 }}>
          ...
          <div style={{ background: "#fff", padding: "100px 64px" }}>
            <div style={{ display: "flex", flexDirection: "column" as const, gap: 0 }}>
              {[
                ...
                { stat: "Sending $200 home costs $14–28 in fees. Every single time", sub: "7–14% lost in transit before the money arrives. A tax on keeping your family afloat." },
        ...
        <div style={{ background: "var(--mv-n50)", padding: "80px 64px", borderBottom: "1px solid #e5e5e5" }} className="section-pad-responsive">
          <div style={{ maxWidth: 1040, margin: "0 auto" }}>
            <span className="accent-rule" style={{ marginBottom: 32 }} />
            <h2 style={{ fontFamily: "'Playfair Display', serif", fontWeight: 900, fontSize: "clamp(1.6rem, 3vw, 2.8rem)", color: "var(--mv-black)", lineHeight: 1.15, marginBottom: 48 }}>
        ...
        <div style={{ background: "var(--mv-black)", padding: "80px 64px" }} className="section-pad-responsive">
          <div style={{ maxWidth: 1040, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 80, alignItems: "start" }} className="two-col-grid">
            <div>
              <span className="accent-rule" style={{ marginBottom: 32 }} />
              <h2 style={{ fontFamily: "'Playfair Display', serif", fontWeight: 900, fontSize: "clamp(1.8rem, 3vw, 2.8rem)", color: "#fff", lineHeight: 1.15 }}>
                Hard work should build wealth<br />Not watch it drain
              </h2>
            </div>
            <div style={{ display: "flex", flexDirection: "column" as const, gap: 28, paddingTop: 8 }}>
              {[
                "People who save responsibly are the ones who pay for bad monetary policy — through silent inflation they never voted for.",
                "Financial sovereignty knowledge is available in English finance podcasts for Western audiences, but not built for Yoruba, Twi, or Swahili speakers.",
                "The African diaspora sends over $100 billion home every year and loses billions in remittance fees on every single transfer.",
              ].map((line, i) => (
        ...
        <div style={{ maxWidth: 1040, margin: "0 auto" }}>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 80, alignItems: "start" }} className="two-col-grid">
            <div>
              ...
              <p style={{ fontFamily: "'Inter', sans-serif", fontSize: 15, color: "var(--mv-n600)", lineHeight: 1.85, marginBottom: 36 }}>
            ...
            <div style={{ display: "flex", flexDirection: "column" as const, gap: 0, border: "2px solid var(--mv-black)" }}>
              {[
                { num: "85", label: "Lessons covering every protocol from fiat fundamentals to exit architecture, no prior knowledge required" },
      ...
      <section style={{ background: "var(--mv-n50)", padding: "120px 64px", borderBottom: "2px solid var(--mv-black)" }} className="section-pad-responsive">
        ...
        <div style={{ marginTop: 40, display: "flex", alignItems: "center", gap: 28, flexWrap: "wrap" as const }}>
          <Link href="/pricing">
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 64, alignItems: "center" }} className="two-col-grid">
          <div>
            ...
            <p style={{ fontFamily: "'Inter', sans-serif", fontSize: 15, color: "var(--mv-n400)", lineHeight: 1.85, marginBottom: 32 }}>
              17 pages on why fiat currencies fail, how the 4-year Bitcoin halving cycle works, and the exact five mistakes that cost most investors their position. No email required. No purchase. Just the thesis.
            </p>
            <Link href="/free-guide">
          ...
          <div style={{ borderLeft: "1px solid #222", paddingLeft: 64 }} className="guide-form-col">
            <p style={{ fontFamily: "'Space Mono', monospace", fontSize: 9, letterSpacing: "0.15em", color: "var(--mv-n600)", marginBottom: 20, textTransform: "uppercase" as const }}>
              Or get the guide with the full email sequence
            </p>
            <LeadCaptureForm />
          </div>
        </div>
      ...
      <section style={{ background: "var(--mv-black)", borderTop: "2px solid #222", position: "relative" as const, overflow: "hidden" }} className="hero-pad">
        ...
        <div style={{ position: "relative" as const, zIndex: 1, maxWidth: 900 }}>
          <span className="accent-rule" style={{ marginBottom: 48 }} />
          ...
          <div style={{ marginBottom: 56, paddingBottom: 56, borderBottom: "1px solid #222" }}>
            <h2 style={{ fontFamily: "'Playfair Display', serif", fontWeight: 900, fontSize: "clamp(1.8rem, 3.8vw, 4rem)", color: "var(--mv-n500)", lineHeight: 1.0, marginBottom: 24 }}>
              Without a protocol, the next halving will pass the same way the last one did
            </h2>
            <p style={{ fontFamily: "'Inter', sans-serif", fontSize: 15, color: "var(--mv-n600)", lineHeight: 1.85, maxWidth: 680 }}>
              Bitcoin went from $8,000 to $69,000 in the last cycle. Most people found out when the price was already at the top — no position, no exit plan, no protocol. The 2024 halving has already happened. The cycle is live.
            </p>
          </div>
          ...
          <p style={{ fontFamily: "'Playfair Display', serif", fontStyle: "italic", fontSize: "clamp(16px, 1.6vw, 21px)", color: "var(--mv-n400)", maxWidth: 720, lineHeight: 1.8, marginBottom: 52 }}>
            The Blueprint exists so that when the next cycle peaks, you're the one with the cold storage, the DCA running, and the exit orders pre-set — building generational wealth in the background while others watch from the sidelines.
          </p>
      ...
      <style>{`
        ...
        .cta-strip-pad { padding: 40px 64px; }
        @media (max-width: 768px) {
          ...
          .cta-strip-pad { padding: 32px 20px !important; }
        }
      `}</style>
    </Layout>
  );
